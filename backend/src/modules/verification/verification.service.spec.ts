...
describe('VerificationService', () => {
  ...
  describe('requestVerification', () => {
    ...
    it('should throw ConflictException if pending request exists', async () => {
      ...
      await expect(service.requestVerification(userId)).rejects.toThrow(ConflictException);
    });
    ...
    it('should enforce rate limit', async () => {
      ...
      await expect(service.requestVerification(userId)).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('submitVerification', () => {
    ...
    it('should reject expired verification codes', async () => {
      ...
      await expect(service.submitVerification(userId, dto)).rejects.toThrow(BadRequestException);
    });
  });
});
