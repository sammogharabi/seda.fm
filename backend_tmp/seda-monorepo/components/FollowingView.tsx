            ...
            <div className="p-6">
              <TabsContent value="following" className="mt-0 space-y-4">
                {followingList.map((followedUser) => (
                  <Card key={followedUser.id} className="border border-border hover:border-border shadow-sm hover:shadow-md transition-all duration-200">
              ...
              <TabsContent value="discover" className="mt-0 space-y-4">
                {suggestedList.map((suggestedUser) => (
                  <Card key={suggestedUser.id} className="border border-border hover:border-border shadow-sm hover:shadow-md transition-all duration-200">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        <Avatar className="w-12 h-12 shadow-sm">
