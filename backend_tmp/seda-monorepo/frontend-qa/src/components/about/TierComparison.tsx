    ...
    <section className="about-section about-section-padding px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl sm:text-4xl font-medium text-foreground mb-2">
            Tiers & Pricing Overview
          </h2>
        </motion.div>

        <div className="grid md:grid-cols-2 gap-[25px] mb-[30px]">
          {/* Free Tier */}
          <motion.div
          ...
          >
            <div className="mb-8">
              <h3 className="text-2xl font-medium text-foreground my-[21px] px-6 py-4">Free (with ads)</h3>
          ...
          >
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-medium text-foreground my-[21px] px-6 py-4">Premium (ad-free)</h3>
