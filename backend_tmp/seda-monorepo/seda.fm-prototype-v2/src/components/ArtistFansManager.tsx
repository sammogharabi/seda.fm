                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3 flex-1">
                            <div className="relative">
                              <div className={`w-12 h-12 bg-accent-${fan.accentColor || 'coral'}/10 border border-accent-${fan.accentColor || 'coral'}/20 rounded-full flex items-center justify-center`}>
                                <span className="font-medium">{fan.displayName[0]}</span>
                              </div>
                            </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          <div className="relative flex-shrink-0">
                            <div className={`w-10 h-10 bg-accent-${fan.accentColor || 'coral'}/10 border border-accent-${fan.accentColor || 'coral'}/20 rounded-full flex items-center justify-center`}>
                              <span className="text-sm font-medium">{fan.displayName[0]}</span>
                            </div>
                          </div>
