          ...
          {filteredSuggestions.map((user) => (
            <div key={user.id} className="flex items-center justify-between p-3 bg-secondary/30 border border-foreground/10 hover:border-foreground/20 transition-all">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-accent-mint text-background flex items-center justify-center font-semibold text-sm border border-foreground/20">
          ...
          <Card key={user.id} className="hover:border-foreground/20 transition-colors">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-accent-coral text-background hidden md:flex items-center justify-center font-semibold text-lg border border-foreground/20">
                  {user.displayName[0].toUpperCase()}
                </div>
