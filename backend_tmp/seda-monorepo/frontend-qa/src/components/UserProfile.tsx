    ...
    <div className="flex-1 p-4 md:p-6 space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-3 mb-2">
                <h1 className="text-xl md:text-2xl">{user.username}</h1>
                <div className="flex items-center justify-center md:justify-start gap-2">
                  {user.verified && <Crown className="w-5 h-5 md:w-6 md:h-6 text-yellow-500" />}
                  {user.isArtist && (
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="truncate">{user.connectedServices.join(', ')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
              ...
              {!user.verified && (
                <Button
                  ...
                  className="bg-gradient-to-r from-[#00ff88] to-[#00ccff] text-black hover:opacity-90 w-full sm:w-auto"
                >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-0">
          ...
          <TabsTrigger value="playlists" className="text-xs md:text-sm">Playlists</TabsTrigger>
        </TabsList>
