...
export function UserProfile({ user, onUpdateUser, viewingUser = null, isOwnProfile = true, defaultTab = 'activity', onBack = null, onFollowToggle = null, isFollowing = false, onSendMessage = null, onFollowUser = null, isFollowingUser = null, onViewChange = null, onBlockUser = null, onUnblockUser = null, isBlocked = null, getBlockedUsers = null }) {
  ...
  }, [safeUser, profileData, onUpdateUser]);
  ...
  // Show loading screen if progression is still loading
          ...
          <div className="border-b border-foreground/10 pb-8">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-shrink-0">
                <div className="w-16 h-16 bg-secondary border border-foreground/20 flex items-center justify-center">
        ...
        {activeTab === 'activity' && (
                      ...
                      >
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: `var(--color-accent-${blockedUser.accentColor || 'coral'})`,
                              borderColor: `var(--color-accent-${blockedUser.accentColor || 'coral'})`,
                            }}
                          >
                            <span className="text-background font-black text-sm">
                              {(blockedUser.displayName || blockedUser.username || 'U')[0].toUpperCase()}
                            </span>
                          </div>
          ...
          {activeTab === 'crates' && (
            <div className="space-y-6 mt-6">
              ...
              {MOCK_CRATES.filter(crate => isOwnProfile || crate.isPublic).length === 0 && (
                <div className="text-center text-muted-foreground py-12">
                  <div className="w-12 h-12 mx-auto mb-4 bg-muted rounded border border-foreground/10 flex items-center justify-center">
