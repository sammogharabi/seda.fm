...
export function SharedHeroSection({ onSignup, onLearnMorePBC }: SharedHeroProps) {
    ...
    <section className="min-h-screen flex flex-col justify-center px-4 py-16 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h1 className="text-4xl text-foreground font-medium">sedā.fm</h1>
        </motion.div>
        ...
        >
          ...
          <span className="bg-gradient-to-r from-primary via-muted-foreground to-primary bg-clip-text text-transparent">community</span>
        </motion.h1>
        ...
        >
          Join the real-time music platform where fans and artists connect, share, and DJ together.
        ...
        >
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-12 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors duration-200">
            ...
            <motion.div className="p-6 bg-card border border-border rounded-lg" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
        ...
        >
          <Button variant="ghost" onClick={onLearnMorePBC} className="text-muted-foreground hover:text-foreground transition-colors duration-200">
