          ...
          <section>
            ...
            <div className="space-y-4">
              {LIVE_SESSIONS.map((session, i) => {
                ...
                return (
                  <motion.div key={session.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: motionTokens.cardEnter.duration, ease: motionTokens.cardEnter.easing, delay: i * 0.03 }}>
                  <Card className={`border-2 transition-all duration-200 ${isListening ? 'border-ring shadow-lg shadow-ring/20 scale-[1.02]' : 'border-border hover:border-border shadow-sm hover:shadow-md'}`}>
          ...
          <section>
            ...
            <div className="space-y-4">
              {RECENT_SESSIONS.map((session, i) => (
                <motion.div key={session.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: motionTokens.cardEnter.duration, ease: motionTokens.cardEnter.easing, delay: i * 0.03 }}>
                <Card className="border border-border hover:border-border shadow-sm hover:shadow-md transition-all duration-200 opacity-75">
                  <CardContent className="p-6">
                    <div className="flex gap-4">
                      {/* DJ Info */}
                      <div className="flex items-start gap-3">
