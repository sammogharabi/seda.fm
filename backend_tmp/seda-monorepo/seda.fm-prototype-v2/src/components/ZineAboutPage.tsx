                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Free tier with ads instead of paywalls</p>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          <div className="space-y-8 relative">
            ...
            >
              ...
              <div className="bg-accent-blue border border-accent-blue p-4 rounded-lg mb-4">
                <p className="text-background text-sm leading-relaxed">
                  <strong>For users who can't afford premium:</strong> We show occasional ads instead of charging money. We'd rather have ads than exclude people based on their financial situation. Everyone deserves access to good music discovery.
                </p>
              </div>
              ...
              >
                ...
                <div className="pt-4">
                  <div className="mb-6">
                    ...
                    <div className="font-mono text-sm text-muted-foreground">WITH OCCASIONAL ADS</div>
                  </div>
                  ...
                  <div className="bg-accent-blue border border-accent-blue p-4 rounded-lg">
                    <div className="font-mono text-xs text-background/70 mb-2">AD EXPERIENCE</div>
                    <p className="text-sm text-background leading-relaxed">
                      Occasional non-intrusive ads between music discoveries. We keep ads minimal and relevant to the music community. No tracking, no data sales.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="pt-4">
                  <div className="mb-6">
                    ...
                    <div className="font-mono text-sm text-muted-foreground">AD-FREE PREMIUM EXPERIENCE</div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-accent-mint" />
                      <span className="text-foreground">Zero ads, ever</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-accent-mint" />
                  ...
                  <div className="bg-accent-coral border border-accent-coral p-4 rounded-lg">
                    <div className="font-mono text-xs text-background/70 mb-2">WHERE YOUR MONEY GOES</div>
                    <div className="space-y-1 text-sm font-mono text-background">
                      <div className="flex justify-between">
                        <span>Platform operations:</span>
                        <span>60%</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Artist support fund:</span>
                        <span>25%</span>
                      </div>
                      <div className="flex justify-between">
